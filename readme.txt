...
%SYS> d ##class(Silent.Installer).LoadCSV("NYTaxi.RowRides","/var/tmp/data/10M.csv") d ##class(Silent.Installer).LoadCSV("NYTaxi.ColumnRides","/var/tmp/data/10M.csv") d ##class(Silent.Installer).LoadCSV("NYTaxi.ColumnRides2","/var/tmp/data/10M.csv")
